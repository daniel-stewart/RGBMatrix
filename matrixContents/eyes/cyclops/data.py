...
EYE_DATA = {
    'eye_image'        : EYE_PATH + 'cyclops-eye.png',
    'upper_lid_image'  : EYE_PATH + 'cyclops-upper-lid.png',
    'lower_lid_image'  : EYE_PATH + 'cyclops-lower-lid.png',
    'stencil_image'    : EYE_PATH + 'cyclops-stencil.png',
