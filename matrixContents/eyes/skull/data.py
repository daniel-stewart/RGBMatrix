...
EYE_DATA = {
    'eye_image'        : EYE_PATH + 'skull-eyes.png',
    'upper_lid_image'  : EYE_PATH + 'skull-upper-lids.png',
    'lower_lid_image'  : EYE_PATH + 'skull-lower-lids.png',
    'stencil_image'    : EYE_PATH + 'skull-stencil.png',
