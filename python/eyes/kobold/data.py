...
EYE_DATA = {
    'eye_image'        : EYE_PATH + 'kobold-eyes.png',
    'upper_lid_image'  : EYE_PATH + 'kobold-upper-lids.png',
    'lower_lid_image'  : EYE_PATH + 'kobold-lower-lids.png',
    'stencil_image'    : EYE_PATH + 'kobold-stencil.png',
